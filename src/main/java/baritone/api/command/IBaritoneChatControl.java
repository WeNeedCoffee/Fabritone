...
public interface IBaritoneChatControl {
	...
	/**
	 * In certain cases chat components need to execute commands for you. For example, the paginator automatically runs commands when you click the forward and back arrows to show you the previous/next page.
	 * <p>
