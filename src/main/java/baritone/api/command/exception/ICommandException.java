...
/**
 * The base for a Baritone Command Exception, checked or unchecked. Provides a {@link #handle(ICommand, List)} method that is used to provide useful output to the user for diagnosing issues that may have occurred during execution.
 * <p>
...
public interface ICommandException {
	...
	default void handle(ICommand command, List<ICommandArgument> args) {
		HELPER.logDirect(getMessage(), Formatting.RED);
	}
}
