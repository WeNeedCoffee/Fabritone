...
public interface IArgParser<T> {
	...
	/**
	 * A stated argument parser is similar to a stateless one. It also takes a {@link ICommandArgument}, but it also takes a second argument that can be any type, referred to as the state.
	 */
	interface Stated<T, S> extends IArgParser<T> {
		 ...
		 * @throws RuntimeException if you want the parsing to fail. The exception will be caught and turned into an appropriate error.
		 */
