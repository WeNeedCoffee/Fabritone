...
/**
 * An {@link IDatatype} is similar to an {@link IArgParser} in the sense that it is capable of consuming an argument to transform it into a usable form as the code desires.
 * <p>
 ...
 * <p>
 * Another difference is that an {@link IDatatype} can be tab-completed, providing comprehensive auto completion that can substitute based on existing input or provide possibilities for the next piece of input.
 *
...
public interface IDatatype {
	...
	/**
	 * Attempts to complete missing or partial input provided through the {@link IArgConsumer}} provided by {@link IDatatypeContext#getConsumer()} in order to aide the user in executing commands.
	 * <p>
