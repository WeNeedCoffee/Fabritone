...
public enum RelativeGoalBlock implements IDatatypePost<GoalBlock, BetterBlockPos> {
	...
	public GoalBlock apply(IDatatypeContext ctx, BetterBlockPos origin) throws CommandException {
		...
		return new GoalBlock(MathHelper.floor(consumer.getDatatypePost(RelativeCoordinate.INSTANCE, (double) origin.x)), MathHelper.floor(consumer.getDatatypePost(RelativeCoordinate.INSTANCE, (double) origin.y)), MathHelper.floor(consumer.getDatatypePost(RelativeCoordinate.INSTANCE, (double) origin.z)));
	}
