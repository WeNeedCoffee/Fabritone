...
/**
 * A {@link ICommandArgument} is an immutable object representing one command argument. It contains data on the index of that argument, its value, and the rest of the string that argument was found in
 * <p>
...
public interface ICommandArgument {
	 ...
	 * <p>
	 * For example if you getEnum as an {@link Direction}, and this argument's value is "up", it will return {@link Direction#UP}
	 *
