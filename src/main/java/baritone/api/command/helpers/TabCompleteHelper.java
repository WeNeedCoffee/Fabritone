...
/**
 * The {@link TabCompleteHelper} is a <b>single-use</b> object that helps you handle tab completion. It includes helper methods for appending and prepending streams, sorting, filtering by prefix, and so on.
 * <p>
 ...
 * <li>Sort using {@link #sort(Comparator)} or {@link #sortAlphabetically()} and then filter by prefix using {@link #filterPrefix(String)}</li>
 * <li>Get the stream using {@link #stream()}</li>
 * <li>Pass it up to whatever's calling your tab complete function (i.e. {@link ICommandManager#tabComplete(String)} or {@link IArgConsumer}#tabCompleteDatatype(IDatatype)})</li>
 * </ul>
 * <p>
 * For advanced users: if you're intercepting {@link TabCompleteEvent}s directly, use {@link #build()} instead for an array.
 */
public class TabCompleteHelper {
	...
	public TabCompleteHelper addSettings() {
		return append(BaritoneAPI.getSettings().allSettings.stream().map(Settings.Setting::getName).filter(s -> !s.equalsIgnoreCase("logger")).sorted(String.CASE_INSENSITIVE_ORDER));
	}
	...
	/**
	 * Apply the specified {@code filter} to every element <b>currently</b> in this {@link TabCompleteHelper} and return this object for chaining
	 *
	...
	/**
	 * Apply the specified {@code transform} to every element <b>currently</b> in this {@link TabCompleteHelper} and return this object for chaining
	 *
	...
	/**
	 * Apply the specified {@code sort} to every element <b>currently</b> in this {@link TabCompleteHelper} and return this object for chaining
	 *
	...
	/**
	 * Sort every element <b>currently</b> in this {@link TabCompleteHelper} alphabetically and return this object for chaining
	 *
	 * @return This {@link TabCompleteHelper}
	 */
