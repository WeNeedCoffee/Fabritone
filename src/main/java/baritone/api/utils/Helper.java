...
/**
 * An ease-of-access interface to provide the {@link MinecraftClient} game instance, chat and console logging mechanisms, and the Baritone chat prefix.
 *
 * @author Brady
 * @since 8/1/2018
 */
public interface Helper {
	...
	/**
	 * Send a message to the toaster to show it as a popup Send components to popup with the [Baritone] prefix (title)
	 *
