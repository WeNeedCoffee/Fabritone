...
public final class RayTraceUtils {
	...
	/**
	 * Performs a block raytrace with the specified rotations. This should only be used when any entity collisions can be ignored, because this method will not recognize if an entity is in the way or not. The local player's block reach distance will be used.
	 *
