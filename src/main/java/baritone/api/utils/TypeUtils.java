...
public final class TypeUtils {
	...
	/**
	 * Resolves the "base type" for the specified type. For example, if the specified type is {@code List<String>}, then {@code List.class} will be returned. If the specified type is already a class, then it is directly returned.
	 *
