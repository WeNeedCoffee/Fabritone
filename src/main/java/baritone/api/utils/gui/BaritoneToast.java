...
public class BaritoneToast implements Toast
{
    ...
    public Visibility draw(ToastManager toastGui, long delta)
    {
        ...
        {
            toastGui.getGame().textRenderer.draw(this.title, 18, 12, -11534256);
        }
        else
        {
            toastGui.getGame().textRenderer.draw(this.title, 18, 7, -11534256);
            toastGui.getGame().textRenderer.draw(this.subtitle, 18, 18, -16777216);
        }
