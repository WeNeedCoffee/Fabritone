...
public interface IBaritoneProvider {
	...
	/**
	 * Returns all of the active {@link IBaritone} instances. This includes the local one returned by {@link #getPrimaryBaritone()}.
	 *
	...
	/**
	 * Provides the {@link IBaritone} instance for a given {@link ClientPlayerEntity}. This will likely be replaced with or be overloaded in addition to {@code #getBaritoneForUser(IBaritoneUser)} when {@code bot-system} is merged into {@code master}.
	 *
	...
	/**
	 * Returns the {@link ICommandSystem} instance. This is not bound to a specific {@link IBaritone} instance because {@link ICommandSystem} itself controls global behavior for {@link ICommand}s.
	 *
	...
	/**
	 * Returns the primary {@link IBaritone} instance. This instance is persistent, and is represented by the local player that is created by the game itself, not a "bot" player through Baritone.
	 *
	...
	/**
	 * Returns the {@link IWorldScanner} instance. This is not a type returned by {@link IBaritone} implementation, because it is not linked with {@link IBaritone}.
	 *
