...
/**
 * An implementation of {@link IGameEventListener} that has all methods overridden with empty bodies, allowing inheritors of this class to choose which events they would like to listen in on.
 *
 * @author Brady
