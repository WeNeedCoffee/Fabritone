...
public interface IMineProcess extends IBaritoneProcess {
	...
	/**
	 * Begin to search for and mine the specified blocks until the number of specified items to get from the blocks that are mined. This is based on the first target block to mine.
	 *
