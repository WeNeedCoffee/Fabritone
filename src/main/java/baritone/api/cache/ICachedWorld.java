...
public interface ICachedWorld {
	...
	/**
	 * Scans the cached chunks for location of the specified special block. The information that is returned by this method may not be up to date, because older cached chunks can contain data that is much more likely to have changed.
	 *
	...
	/**
	 * Queues the specified chunk for packing. This entails reading the contents of the chunk, then packing the data into the 2-bit format, and storing that in this cached world.
	 *
	...
	/**
	 * Reloads all of the cached regions in this world from disk. Anything that is not saved will be lost. This operation does not execute in a new thread by default.
	 */
