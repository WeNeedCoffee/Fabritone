...
public interface IPathingBehavior extends IBehavior {
	...
	/**
	 * @return If there is a current path. Note that the path is not necessarily being executed, for example when there is a pause in effect.
	 * @see #isPathing()
	 */
	...
	/**
	 * Returns the estimated remaining ticks in the current pathing segment. Given that the return type is an optional, {@link Optional#empty()} will be returned in the case that there is no current segment being pathed.
	 *
