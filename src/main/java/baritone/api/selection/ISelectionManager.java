...
/**
 * The selection manager handles setting Baritone's selections. You can set the selection here, as well as retrieving the current selection.
 */
public interface ISelectionManager {
	...
	/**
	 * Replaces the specified {@link ISelection} with one contracted in the specified direction by the specified number of blocks.
	 * <p>
	...
	/**
	 * Replaces the specified {@link ISelection} with one expanded in the specified direction by the specified number of blocks. Returns the new selection.
	 *
	...
	/**
	 * This method will always return the last selection. ONLY use this if you want to, for example, modify the most recent selection based on user input. ALWAYS use {@link #getOnlySelection()} or, ideally, {@link #getSelections()} for retrieving the content of selections.
	 *
	...
	/**
	 * For anything expecting only one selection, this method is provided. However, to enforce multi-selection support, this method will only return a selection if there is ONLY one.
	 *
	...
	/**
	 * Replaces the specified {@link ISelection} with one shifted in the specified direction by the specified number of blocks. This moves the whole selection.
	 *
