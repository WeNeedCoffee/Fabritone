...
/**
 * Useful if the goal is just to mine a block. This goal will be satisfied if the specified {@link BlockPos} is at to or above the specified position for this goal.
 *
 * @author leijurv
 */
