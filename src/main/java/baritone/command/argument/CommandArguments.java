...
public final class CommandArguments {
	 ...
	 * @param preserveEmptyLast If the string ends with whitespace, add an empty {@link ICommandArgument} to the end This is useful for tab completion
	...
	/**
	 * Returns an "unknown" {@link CommandArgument}. This shouldn't be used unless you absolutely have no information - ESPECIALLY not with {@link CommandInvalidArgumentException}s
	 *
