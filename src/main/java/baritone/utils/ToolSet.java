...
public class ToolSet {
	...
	/**
	 * Calculates how long would it take to mine the specified block given the best tool in this toolset is used. A negative value is returned if the specified block is unbreakable.
	 *
	...
	/**
	 * A cache mapping a {@link Block} to how long it will take to break with this toolset, given the optimum tool is used.
	 */
