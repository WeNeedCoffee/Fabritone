...
public class Selection implements ISelection {
	...
	public Selection(BetterBlockPos pos1, BetterBlockPos pos2) {
		...
		aabb = new Box(min, max.add(1, 1, 1));
	}
	 ...
	 * <p>
	 * Let's say you specify Direction.UP, this functions returns if pos2 is the highest BlockPos. If you specify Direction.DOWN, it returns if pos2 is the lowest BlockPos.
	 *
	 * @param facing The direction to check.
	 * @return {@code true} if pos2 is further in that direction than pos1, {@code false} if it isn't, and something else if they're both at the same position on that axis (it really doesn't matter)
	 */
